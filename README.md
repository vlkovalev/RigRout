...
| Truck stop / rest area / cardlock / weigh station / EV / border POI layers | Implemented via OpenStreetMap/Overpass. The rest/pull-off layer additionally merges both official Alberta 511 inventories for rest areas, highway turnouts, commercial rest stops, surface/status information, washrooms, brake-checks, chain areas, and scenic viewpoints. |
